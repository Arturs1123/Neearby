  ...
  <div class="product-content-wrapper">
    ...
    <div class="input-container inline" style="display: block">
      <div class="dsadada" style="display: flex;align-items: center;">
        <p style="margin-top: 24px"><b class="title"> Изображение товара:</b> (Рекомендуемое разрешение 1250 x 250. Формат
          - JPG, WEBP или PNG)</p>
    ...
    <div class="input-container">
      ...
      <input style="color: #2A5885;" type="text" v-model="product.product_link">
    </div>
    ...
    <div class="input-container">
      ...
      <input style="color: #2A5885;" type="text" v-model="product.download_link">
    </div>
    <div class="inputs_group">
      <div class="title">Создать группу подписчиков товара покупателей:</div>
...
<!--    </div>-->
    ...
    <div class="button-add" style="width: 221px;height: 44px;margin-right: auto;
          margin-left: auto;">
      <button class="type-box active" @click="createProduct"> Добавить товар </button>
    </div>
...
export default {
  ...
  methods: {
    createProduct: function () {
      ...
      ApiWrapper.createProduct(formData).then(result => {
        localStorage.removeItem('already');
        localStorage.setItem('productId', result.data.data.id);

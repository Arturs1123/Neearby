          ...
          <div class="moderation-body">
            <div class="title">
              <div class="moderation-title">
                <div class="fdsfsfsfs">
                  <img style="width: 40px; height: 40px; transform: rotate(180deg);" src="../../assets/card_t1zo602rnrco.svg" alt="">
                  <p class="jblojka">Обложки</p>
                </div>
...
export default {
  ...
  methods: {
    ...
    cancel(el) {
      ApiWrapper.cancelCover({id: el.id, status: 2})
          .then(() => {
            const toast = useToast();
    ...
    async openModeration() {
      this.step = 1;
      await ApiWrapper.getModerationCovered()
          .then(res => {
    ...
    async openModerationAccept() {
      this.step = 2;
      await ApiWrapper.getModerationAcceptCover()
          .then(response => {
    ...
    async openModerationCancel() {
      this.step = 3;
      await ApiWrapper.getModerationCancelCover()
          .then(response => {

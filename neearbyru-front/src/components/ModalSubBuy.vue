    ...
    <div class="full_desc">
      <div class="full_desc_h">
        <div class="full_desc_h_l">
          ...
          <span>Полное описание “{{subscriptionObject.title}}”</span>
        </div>
      ...
      <div class="full_modal">
        ...
        <div class="full_modal_info">
          <img :src="subscriptionObject.subscription_image_path" alt="" style="max-width: 275px; height: 200px">
          ...
          <div class="social_info">
            ...
            <div class="views_info">
              <img src="../assets/TwentyOffer/ic_views.svg" alt="">{{ subscriptionObject.likes }}
            </div>
          </div>
        </div>
      </div>

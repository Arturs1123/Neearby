<template>
  <div class="sidebar-wrapper">
    <div class="sidebar-buttons">
      <SidebarMenuItem :icon-path="require('../../assets/mypage.svg')" label="Пользователи" link="/admin-panel"></SidebarMenuItem>
      <SidebarMenuItem :icon-path="require('../../assets/news.svg')" label="Модерация"></SidebarMenuItem>
      <SidebarMenuItem :icon-path="require('../../assets/messages.svg')" label="Обложки" link="/admin-panel/moderation-covers"></SidebarMenuItem>
      <SidebarMenuItem :icon-path="require('../../assets/posts.svg')" label="Аватарки" link="/admin-panel/moderation-avatars"></SidebarMenuItem>
      <SidebarMenuItem :icon-path="require('../../assets/orders.svg')" label="Товары" link="/admin-panel/moderation-product"></SidebarMenuItem>
      <SidebarMenuItem :icon-path="require('../../assets/products.svg')" label="Подписки" link="/admin-panel/moderation-subscription"></SidebarMenuItem>
      <SidebarMenuItem :icon-path="require('../../assets/subscriptions-menu-icon.svg')" label="Посты" link="/admin-panel/moderation-post"></SidebarMenuItem>
    </div>
  </div>
...
export default {
  ...
  methods: {
    ...
    openFavorsPage() {
      let domain = window.location.host
      window.location.href = "http://" + domain + '/favors';
    },

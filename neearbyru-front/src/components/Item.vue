    ...
    <div class="modal-body">
      ...
      <div>
        <p style="text-align: left; font-size: 18px; line-height: 25px; margin-top: 15px; color: gray;" class="text-modal">
          В течений 5 минут мы проверим Ваш товар, и если <br> она соответсвует правилам сервиса Neearby.pro<br> мы ее опубликуем!
        </p>
      </div>
    ...
    <div class="modal-body">
      ...
      <div>
        <p style="text-align: left; font-size: 16px; line-height: 20px; color: gray;" class="text-modal">
          Коментарии от модератора: В название товара нельзя <br>
          указывать нецензурную лексику. В описание товара <br>
          нельзя обещать бешенные проценты ничего не делая. А <br>
          изображение Вашего товара не должно нарушать <br>
          авторские права.
        </p>
      </div>
      <div>

<template>
  <div class="product-preview">
    ...
    <div style="cursor: pointer;display: contents;">
      ...
      <div class="product-title" v-if="subscriptionObject.active == 2">
        <h3>Заголовок</h3>
      </div>

      <div class="product-title" v-if="subscriptionObject.active == 1">
      ...
      <div style="display: flex; flex-direction: row; align-items: center;" class="product-price">
        <h4 style="margin-left: 80px;">{{ subscriptionObject.price }}₽</h4>
        <div
...
<!--  </VueFinalModal>-->
<!--  <VueFinalModal v-model="showProductsModal">-->
<!--    <SubSocial :step="step" v-if="showProductsModal" @close="showProductsModal=false" :subscription-object="subscriptionObject" :profile="profile" />-->
<!--  </VueFinalModal>-->

<template>
    ...
    <div v-if="product.active == 2" style="background: yellow; height: auto; display: flex; flex-direction: column;margin-top: 50px;" class="add-product-wrapper">
    ...
    <div class="product-content-wrapper">
        ...
        <div class="input-container">
            ...
            <input type="text" v-model="product.product_link">
        </div>
        ...
        <div class="input-container inline">
            ...
            <div class="field">
                ...
                <input class="ruble" v-model="product.discount_price" type="text">
            </div>
        </div>
...
export default {
  ...
  methods: {
      createProduct: function (){
        ...
        formData.append("download_link",  this.product.download_link);
        formData.append("product_link",  this.product.product_link);
        // if(this.image){

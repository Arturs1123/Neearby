  ...
  <div class="modal_wrapper">
    <div class="modal_social">
      ...
      <div class="modal_social_i">
        ...
        <div style="overflow: hidden;overflow-y: scroll;height: 400px;" v-if="step == 2">
          ...
          <div class="send_msg">
            ...
            <div class="input_msg">
              <input type="text" placeholder="Написать комментарий..." v-model="comment">
...
export default {
  ...
  methods: {
    ...
    async commentProduct(productId) {
      await ApiWrapper.commentProduct({productId: this.product.id, comment: this.comment, img: this.profilePicturePath, name: this.profileName}).then(() =>{
        ApiWrapper.getCommentById({target_id: this.product.id}).then(response => {
          this.comment = '';
          this.comments = response.data
        })
      });
